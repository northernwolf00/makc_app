...
class _BottomNavbarButtonState extends State<BottomNavbarButton> {
  List iconsLight = [
    CustomIcon(
      title: 'assets/icons/h1.svg',
      height: 32,
      width: 32,
      color: AppColors.disableColor,
    ),
    CustomIcon(
      title: 'assets/icons/h2.svg',
      height: 32,
      width: 32,
      color: AppColors.disableColor,
    ),
    CustomIcon(
      title: 'assets/icons/h3.svg',
      height: 32,
      width: 32,
      color: AppColors.disableColor,
    ),
    CustomIcon(
      title: 'assets/icons/h4.svg',
      height: 32,
      width: 32,
      color: AppColors.disableColor,
    ),
    CustomIcon(
      title: 'assets/icons/h5.svg',
      height: 32,
      width: 32,
      color: AppColors.disableColor,
    ),
                    ...
                    child: widget.index != widget.selectedIndex
                        ...
                        : widget.icon
                            ...
                            : Padding(
                                ...
                                child:
                                    Container(child: iconsBold[widget.index]),
                              ),
                  ),
                  Padding(
